...
public class req_change_team_goal
{
	public class request : SprotoTypeBase
	{
		...
		public bool HasMinLevel => has_field.has_field(1);
		...
		public bool HasMaxLevel => has_field.has_field(2);
		...
		public bool HasRecruit => has_field.has_field(4);
		...
		public override int encode(SprotoStream stream)
		{
			...
			{
				serialize.write_integer(minLevel, 1);
			}
			if (has_field.has_field(2))
			{
				serialize.write_integer(maxLevel, 2);
			}
			...
			{
				serialize.write_integer(recruit, 4);
			}
